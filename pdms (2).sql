...
--
-- Host: localhost
-- Generation Time: Nov 13, 2018 at 08:11 AM
...
INSERT INTO `placed_students` (`usn`, `name`, `branch`, `cname`, `package`, `year`) VALUES
('2kl16cs421', 'nidhi', 'EC', 'TCS', '5 lakh', 2013);
...
INSERT INTO `reg_po` (`pid`, `name`, `username`, `password`) VALUES
('1', 'sushant', 'sushant', '12'),
('4', 'sushant', 'sushant', '123');
